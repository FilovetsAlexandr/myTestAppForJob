...
extension PhotosListViewModel {
    struct State: Equatable {
        ...
        var postPhotoInput: PostPhotoInput = .init(name: "Alexandr Filovets", photo: Data(), typeId: -1)
    }
...
extension PhotosListViewModel {
    ...
    private static func userInput(input: AnyPublisher<Event, Never>) -> Feedback<State, Event> { Feedback { _ in input } }
}
